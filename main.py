    ...
    try:
        ...
        if not michigan_covid_df.empty:
            plot_cases_with_bars(
                ...
                "Number of Weekly New Michigan COVID-19 Cases", start_date, end_date, seasons
            )
        ...
        if not national_covid_df.empty:
            plot_cases_with_bars(
                ...
                "Number of Weekly New National COVID-19 Cases", start_date, end_date, seasons
            )
        ...
        if not michigan_flu_df.empty:
            plot_cases_with_bars(
                ...
                "Number of Weekly New Michigan Flu Cases", start_date, end_date, seasons
            )
        ...
        if not national_flu_df.empty:
            plot_cases_with_bars(
                ...
                "Number of Weekly New National Flu Cases", start_date, end_date, seasons
            )
